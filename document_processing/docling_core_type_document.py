# docling_core_type_document.py
# This file is a copy of docling-core/docling_core/types/doc/document.py
# with the following changes:
# export_to_markdown() has a new parameter "include_page_numbers"
